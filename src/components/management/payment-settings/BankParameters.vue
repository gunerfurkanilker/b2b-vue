<template>
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-lg-12 mb-5">
        <v-pagination
          ...
          class="my-4"
          :length="
            this.bankParametersList.length % this.perPage == 0 &&
            this.bankParametersList.length > this.perPage
              ? this.bankParametersList.length / this.perPage
              : parseInt(this.bankParametersList.length / this.perPage) + 1
          "
          :total-visible="5"
        ></v-pagination>
      </div>
    ...
    <EditBankParametersDialog
      :bankParameterProp="bankParameter"
...
export default {
  ...
  methods: {
    ...mapActions("bank",["fetchBankParametersList"]),
    openBankParametersDialog(processType,data = null) {
      this.bankParameter = data;
